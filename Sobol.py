...
replicates = 10  #10
max_steps = 100  #100
distinct_samples = 32 #5 #has to be even for Sobol analysis!
...
if __name__ == "__main__":
    # Prepare CSV file
    columns = problem['names'] + ['CV_Active']
    ...
    # Sobol analysis
    Si_active = sobol.analyze(problem, data['CV_Active'].values.astype(float), print_to_console=True)
